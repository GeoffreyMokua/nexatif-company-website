  ...
  return (
    <>
      <div className="site-content">
        <PageHeader
          title="Construction"
          description="One thing for certain though, is that irrespective of the number of steps the experts talk about, they all originate from the same roots."
          overlay="rgba(2, 45, 98, 0.5)"
          PagaHeaderBg={PagaHeaderImg}
          breadCrumbItems={[
            { label: 'Home', path: '/' },
            { label: 'Pages', path: '#' },
            { label: 'Industries 3', path: '#', active: true },
          ]}
        />
          ...
          >
            <Container>
              <Row className="pb-4 pb-md-5">
                <Col lg={6}>
                    <h3 className="text-white mb-4 mb-md-5">Making a decision to do something this is the first step. We all know that nothing moves until someone makes a decision.</h3>
                </Col>
                <Col lg={6}>
                    <Row className="pb-md-5">
                        <Col sm={6} className="mb-3 mb-lg-0">
                            <Counter
                                ...
                                separator="%"
                                countSize="lg"
                                countTitle="The old expression is absolutely true"
                            />
                        </Col>
                        <Col sm={6} className="mb-4 mb-lg-0">
                            <Counter
                                ...
                                separator="%"
                                countSize="lg"
                                countTitle="Once you have a clear understanding of what you want,"
                            />
                        </Col>
                    </Row>
                </Col>
              ...
              <Row>
                <Col lg={6} className="mb-4 mb-lg-0">
                    <img className="img-fluid border-radius-5" src={image1} alt="" />
                </Col>
                <Col lg={6}>
                    <img className="img-fluid border-radius-5" src={image2} alt="" />
                </Col>
              </Row>
            </Container>
          </section>
